# Online Retail Performance Analysis Project
...
Each dashboard provides an interactive user experience, allowing users to explore and highlight factors they deem important. To interact with the dashboards visit: ['Tableau Public'](https://public.tableau.com/views/OnlineShoppingAnalyticsProject_17688029928250/OnlineShoppingInsightsHub?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
